...
// Endpoint legacy verify-risk dinonaktifkan agar PIN/device-token statis tidak menjadi jalur publik.
...
module.exports = async function handler(req, res) {
  ...
  return res.status(410).json({
    ...
    ok: false,
    disabled: true,
    error: 'Endpoint legacy verify-risk sudah dinonaktifkan. Gunakan /api/2fa/start-step dan /api/2fa/verify-step.'
  });
};

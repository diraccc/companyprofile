...
function getFallbackDomainProducts() {
  return [
    {
      id: null,
      name: 'Paket Website Domain Basic',
      price: 150000,
      description: 'Fallback produk aktif DiracGroup.',
    ...
    {
      id: null,
      name: 'Paket Jasa Pembuatan Website Basic',
      price: 500000,
      description: 'Fallback produk aktif DiracGroup.',
      product_category: 'website_service',
      category: 'website_service',
      is_active: true,
      created_at: null,
      updated_at: null
    },
    {
      id: null,
      name: 'Paket Pengembangan Website',
      price: 750000,
      description: 'Fallback produk aktif DiracGroup.',
      product_category: 'development_service',
      category: 'development_service',
      is_active: true,
      created_at: null,
      updated_at: null
    },
    {
      id: null,
      name: 'Nomor Kosong Basic',
      price: 100000,
      description: 'Fallback produk aktif DiracGroup.',
      product_category: 'empty_number',
      category: 'empty_number',
      is_active: true,
      created_at: null,
      updated_at: null
    }
...
async function domainProducts(req, res) {
  ...
  if (!result.ok) {
    ...
    const allowFallback = code === 'PGRST202' || code === 'PGRST205';

    if (allowFallback) {
      const fallbackProducts = getFallbackDomainProducts();

      return res.status(200).json({
        ok: true,
        source: 'fallback:static-domain-products',
        fallback: true,
        message: 'Produk aktif dimuat dari fallback sementara karena Supabase REST schema cache belum mengenali tabel/function produk.',
